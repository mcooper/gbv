...
load('G://My Drive/GBV/models/spei24_viol_phys_ip_map_ve.Rdata')
load('G://My Drive/GBV/models/spei24_viol_phys_ip_ve.Rdata')
load('G://My Drive/GBV/models/spei24_viol_phys_ip_ve_k50_k500_k500.Rdata')
load('G://My Drive/GBV/models/spei24_viol_phys_ip_map_ve_k100.Rdata')


AIC(spei24_viol_phys_ip_ve)
AIC(spei24_viol_phys_ip_ve_k500)
AIC(spei24_viol_phys_ip_ve_k50_k500_k500)
...
mod <- spei24_viol_phys_ip_ve_k500
...
for (c in names(mod$model)) {
  if (c == 'latitude' | c == 'longitude' | c == 'viol_phys_ip' | c == 'spei24'){
    next
  }
